<div class="modal fade" tabindex="-1" role="dialog" id="addCriptoResource">
    <div class="modal-dialog" role="document">
        <form class="modal-content" method="post" action="{{route('add-cripto-resource')}}">
            <div class="modal-header">
                <h5 class="modal-title">Add cripto-resource</h5>
