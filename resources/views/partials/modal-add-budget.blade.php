<div class="modal fade" tabindex="-1" role="dialog" id="addBudget">
    <div class="modal-dialog" role="document">
        <form class="modal-content" method="post" action="{{route('add-budget')}}">
            <div class="modal-header">
                <h5 class="modal-title">Add article of expenditure</h5>
